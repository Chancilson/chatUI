...
class WeveClipper extends CustomClipper<Path> {
  @override
  Path getClip(Size size) {
    ...
    var secondStart =
        Offset(size.width / 1.5, size.height - 40.0);//third point of quadratic bazier curve
        
    var secondEnd = Offset(size.width*1, size.height);//fourth point of quadratic bazier curve
